...
const Form: React.FC<FormProps> = ({ setWorkout, showForm }) => {
  ...
  const onSubmit = (data: any) => {
    const formatedData: formatedProps = {
      muscle: data.name === "other" ? data.otherMuscleGroup : data.muscle,
  ...
  return (
    <form
      ...
      className="p-6 grid bg-gray-100 rounded-lg shadow-md gap-4"
    >
      <fieldset className="border border-gray-300 p-4 rounded-md">
        ...
        <div className="flex items-center space-x-4 gap-2.5">
          <label>
            ...
            />
            <span
              className={`cursor-pointer py-2 px-4 ease-in-out duration-300 text-white rounded-md ${
                muscleGroup === "legs" ? "bg-green-600" : "bg-secondary"
              }`}
            >
              Legs
            </span>
          ...
          <label>
            ...
            <span
              className={`cursor-pointer py-2 px-4 ease-in-out duration-300 text-white rounded-md ${
                muscleGroup === "back" ? "bg-green-600" : "bg-secondary"
              }`}
            >
              Back
            </span>
          ...
          <label>
            ...
            <span
              className={`cursor-pointer py-2 px-4 ease-in-out duration-300 text-white rounded-md ${
                muscleGroup === "chest" ? "bg-green-600" : "bg-secondary"
              }`}
            >
              Chest
            </span>
          ...
          <label>
            ...
            />
            <span
              className={`cursor-pointer flex gap-2 ease-in-out duration-300 py-2 px-4 text-white rounded-md ${
                muscleGroup === "other" ? "bg-green-600" : "bg-secondary"
              }`}
            >
              Other
              {muscleGroup === "other" && (
      ...
      <div className="mt-4">
        ...
        <div className="flex items-center space-x-2 *:h-10">
          ...
          {// una vez registrado, cualquier elemento que tenga y ejecute un setvalue cambiara el estado y el valor del input sin tener que yo ahcerlo de forma explicita 
          }
          <input
            type="number"
            id="series"
